...
func (s *LogAggregatorTestSuite) TestNewMessageFromSyslog(c *C) {
	...
	c.Assert(m.Hostname, Equals, "a.b.flynn.local")
...
func (s *LogAggregatorTestSuite) TestMessageMarshalJSON(c *C) {
	...
	expected := `{"hostname":"my.flynn.local","job_id":"deadbeef1234","process_type":"web","source":"app","stream":"stderr","timestamp":"2009-11-10T23:00:00.123450789Z"}`
